...
import style from './ButtonForMovePages.module.css';
...
const ButtonForMovePages = ({ setNumberSelect, fetchMovies }) => {
    ...
    const Next = () => {
        if (next <= 500) {
            ...
            setSelectNumber(next)
            setNumberSelect(next)
            fetchMovies()
    ...
    const Last = () => {
        ...
        if (last - 9 >= 0) {
            ...
            setSelectNumber(last)
            setNumberSelect(last)
            setNext(last)
    ...
    return (
        <>
            <div className={style.numberPage}>{selectnumber}</div>
            <div className={style.buttonContainer}>


                <AiFillCaretLeft onClick={() => { Last() }} />
                <ul>
...
export default ButtonForMovePages;
